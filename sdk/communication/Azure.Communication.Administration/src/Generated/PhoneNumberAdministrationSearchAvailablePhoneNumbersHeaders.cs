...
{
    internal class PhoneNumberAdministrationSearchAvailablePhoneNumbersHeaders
    {
        private readonly Response _response;
        public PhoneNumberAdministrationSearchAvailablePhoneNumbersHeaders(Response response)
        {
            _response = response;
        }
